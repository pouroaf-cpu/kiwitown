...
// Data-dependent content for the COO dashboard: controls, KPI tabs and bonus
// reconciliation. Rendered inside a <Suspense> boundary so the frame paints first.
export default function CooPanels({ viewer, initialStaff, initialEntries, initialChecklist, initialTargets, initialAudit, month, year, dailyPreview, showDailyCheck = true }: {
