...
// Data-dependent panels for the super_admin settings page. Rendered inside a
// <Suspense> boundary so the static frame (AppShell + header) can paint first
// while these wait on the Supabase queries. Owns the local mutation state for
// brand settings + role assignments.
